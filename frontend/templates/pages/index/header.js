...
function Header() {
    const Header = `
    <div class="logo">
    <img src="/favicon.png" alt="TMLCS" width="24" height="24">
    <a href="#"> TMLCS CollectionS</a></div>
   ...
   viewBox="0 0 496 496" style="enable-background:new 0 0 496 496;" xml:space="preserve">
     ...
     <path d="M25.068,48.889c-9.173,0-18.017-5.06-22.396-13.804C-3.373,23.008,1.164,8.467,13.003,1.979l2.061-1.129l-0.615,2.268
      ...
      <li>
        <a href="http://tmlcsnetwork.net">TMLCS Network</a>
      </li>
    </ul>
  <nav class="navbar">
      <ul>
        <li><a href="#Main-Content">Incio</a></li>
        <li><a href="#contact">En Temporada</a></li>
        <li><a href="#catalogo">Catalogo</li>
        <li><a href="#about">Colleciones</a></li>
        <li>
          <div class="dropdown">
            <button class="cart-container">
              <svg xmlns="http://www.w3.org/2000/svg" height="14" width="15.75" viewBox="0 0 576 512"><!--!Font Awesome Free 6.5.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.--><path d="M253.3 35.1c6.1-11.8 1.5-26.3-10.2-32.4s-26.3-1.5-32.4 10.2L117.6 192H32c-17.7 0-32 14.3-32 32s14.3 32 32 32L83.9 463.5C91 492 116.6 512 146 512H430c29.4 0 55-20 62.1-48.5L544 256c17.7 0 32-14.3 32-32s-14.3-32-32-32H458.4L365.3 12.9C359.2 1.2 344.7-3.4 332.9 2.7s-16.3 20.6-10.2 32.4L404.3 192H171.7L253.3 35.1zM192 304v96c0 8.8-7.2 16-16 16s-16-7.2-16-16V304c0-8.8 7.2-16 16-16s16 7.2 16 16zm96-16c8.8 0 16 7.2 16 16v96c0 8.8-7.2 16-16 16s-16-7.2-16-16V304c0-8.8 7.2-16 16-16zm128 16v96c0 8.8-7.2 16-16 16s-16-7.2-16-16V304c0-8.8 7.2-16 16-16s16 7.2 16 16z"/></svg>
              <span>Carrito</span>
            </button>
          <div class="dropdown-content">
            <div class="content-style">
             ...
             <div class="promocode">
              <p>PROMO.CODE:</p>
               <input type="text" name="" placeholder="PROMOCiONAL CODE">
             </div>
            <div class="fshop">
              <label>
                <form>
                ...
                <button href="/paypage.html">Terminamos las compras?</button>
                </form>
              </label>
